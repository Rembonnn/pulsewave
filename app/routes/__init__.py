...
def init_routes(app):
    ...
    app.add_url_rule('/api/users/<string:id>', 'get_user_by_id', token_required(user_controller.get_user_by_id), methods=['GET'])
    app.add_url_rule('/api/users/<string:id>', 'update_user', token_required(user_controller.update_user), methods=['PUT'])
    app.add_url_rule('/api/users/<string:id>', 'delete_user', token_required(user_controller.delete_user), methods=['DELETE'])